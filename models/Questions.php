...
class Questions
{
    ...
    /*public function getCarsQuestions ()
    {
      $carsquestions = $this->pdo->query('SELECT questions.id questionsid, questions.firstname firstname, questions.lastname lastname, questions.email email, questions.phone_number phone, questions.message message, questions.car_id questioncarid, questions.reply_id replyid, cars.id carid, validations.id validid, validations.valid valid 
      FROM questions
